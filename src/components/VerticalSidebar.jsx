    ...
    return (
        ...
        >
                    ...
                    return (
                        <NavLink
                            ...
                            className={({ isActive }) => {
                                ...
                                return `${baseClasses} text-black hover:bg-green-50 hover:text-advanta-green-dark`;
                            }}
                        >
                            <module.icon
                                size={22}
            ...
            <div className="border-t border-slate-200 p-2">
                ...
                <NavLink
                    to="/configuracion"
                    className="w-full flex items-center gap-4 px-4 py-2.5 rounded-xl text-black hover:bg-slate-100 transition-all duration-200"
                >
