    ...
    return (
        ...
        >
                    ...
                    return (
                        <NavLink
                            ...
                            className={({ isActive }) => {
                                ...
                                return `${baseClasses} text-advanta-green-dark hover:bg-green-50 hover:text-advanta-green`;
                            }}
                        >
                            <module.icon
                                size={22}
            ...
            <div className="border-t border-slate-200 p-2">
                ...
                <NavLink
                    to="/configuracion"
                    className="w-full flex items-center gap-4 px-4 py-2.5 rounded-xl text-advanta-green-dark hover:bg-green-50 hover:text-advanta-green transition-all duration-200"
                >
