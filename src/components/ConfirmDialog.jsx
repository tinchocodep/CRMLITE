...
export function ConfirmDialog({
    ...
    return createPortal(
        <div
            className="fixed inset-0 z-[10000] flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4 animate-in fade-in duration-200"
            onClick={onClose}
        >
            <div
            ...
            >
                ...
                <div className="px-6 py-4 bg-slate-50 dark:bg-slate-900/50 flex gap-3 justify-end">
                    ...
                    <button
                        ...
                        className="px-4 py-2 bg-gradient-to-r from-[#E76E53] to-red-600 hover:from-[#D55E43] hover:to-red-700 text-white rounded-lg transition-all font-bold shadow-lg shadow-red-500/30"
                    >
                        {confirmText}
                    </button>
                </div>
