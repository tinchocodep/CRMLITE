...
// ─── Branding Lartirigoyen (hardcodeado en esta branch) ───────────────────────
const BRAND = {
    primary: '#006F54',
    primaryDark: '#005240',
    primaryLight: '#008a68',
    companyName: 'Lartirigoyen',
    logoUrl: '/logo_lartirigoyen.png',   // solo el ícono, sin texto
    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{ background: `radial-gradient(circle, ${BRAND.primaryLight}, transparent)` }}
            />
            <div
            ...
            >
                {/* Left Side: Logo Lartirigoyen (solo ícono) */}
                <motion.div
                ...
                >
                    <img
                        ...
                        className="w-full max-w-[220px] md:max-w-[300px] lg:max-w-[380px] h-auto object-contain drop-shadow-2xl"
                        onError={(e) => { e.currentTarget.src = BRAND.logoFallback; }}
                    />
                </motion.div>
                    ...
                    <div className="bg-white/95 backdrop-blur-xl border border-white/20 shadow-2xl rounded-3xl p-6 md:p-10">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onChange={handleChange} placeholder="usuario@empresa.com"
                                ...
                                {errors.email && <p className="text-xs text-red-600 ml-1 flex items-center gap-1"><AlertCircle size={12} />{errors.email}</p>}
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                {errors.password && <p className="text-xs text-red-600 ml-1 flex items-center gap-1"><AlertCircle size={12} />{errors.password}</p>}
                            </div>
                            ...
                            <div className="flex items-center justify-between text-sm">
                                ...
                                <a href="#" style={{ color: BRAND.primary }}
