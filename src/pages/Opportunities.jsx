...
export default function Opportunities() {
    ...
    return (
        <div className="pointer-events-none bg-gradient-to-br from-slate-50 to-slate-100 pb-40 xl:pb-8">
            {/* Header */}
            <div className="pointer-events-auto bg-gradient-to-r from-brand-red to-red-600 text-white p-6 pb-8">
                <h1 className="text-2xl font-bold mb-2">Oportunidades</h1>
                <p className="text-red-100 text-sm">Gestiona tu pipeline de ventas</p>
            </div>

            {/* Stats Cards */}
            <div className="pointer-events-auto px-4 -mt-4 mb-6">
            ...
            {/* Search & Filter */}
            <div className="pointer-events-auto px-4 mb-6">
                {/* Search Bar */}
