                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        ...
                        <motion.div
                            ...
                            className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-2xl p-6 border-2 border-blue-200 dark:border-blue-800"
                        >
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <div className="flex items-center gap-1 text-green-600 dark:text-green-400">
                                    ...
                                    <span className="text-sm font-bold">{conversionMetrics.conversionRate}%</span>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    <span className="text-xs text-slate-500 dark:text-slate-400">Cotizado</span>
                                    <span className="text-sm font-bold text-slate-900 dark:text-white">
                                        {formatCurrency(conversionMetrics.totalQuoted)}
                                    </span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <span className="text-xs text-slate-500 dark:text-slate-400">Cerrado</span>
                                    <span className="text-sm font-bold text-blue-600 dark:text-blue-400">
                                        {formatCurrency(conversionMetrics.totalClosed)}
                                    </span>
                                </div>
                                <div className="pt-2 border-t border-blue-200 dark:border-blue-800">
                                    <div className="flex items-center justify-between text-xs">
                                        <span className="text-slate-500 dark:text-slate-400">
                                            {conversionMetrics.wonOpportunities} de {conversionMetrics.totalOpportunities} oportunidades
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <motion.div
                            ...
                            className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-2xl p-6 border-2 border-green-200 dark:border-green-800"
                        >
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <div className="text-right">
                                    <div className="text-xs text-slate-500 dark:text-slate-400">En Galpón</div>
                                    <div className="text-sm font-bold text-green-600 dark:text-green-400">
                                        {stockMetrics.totalUnits.toLocaleString()} unidades
                                    </div>
                                </div>
                            </div>
                            <h3 className="text-sm font-semibold text-slate-600 dark:text-slate-400 mb-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="pt-2 border-t border-green-200 dark:border-green-800">
                                    <div className="flex items-center justify-between text-xs">
                                        <span className="text-slate-500 dark:text-slate-400">
                                            {stockMetrics.productsInStock} productos diferentes
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <motion.div
                            ...
                            className="bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 rounded-2xl p-6 border-2 border-amber-200 dark:border-amber-800"
                        >
                            <div className="flex items-center justify-between mb-4">
                                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center">
                                    <DollarSign className="w-6 h-6 text-white" />
                                </div>
                                {accountsReceivable.overdueCount > 0 && (
                                    <div className="flex items-center gap-1 text-red-600 dark:text-red-400">
                                        <AlertCircle size={20} />
                                        <span className="text-sm font-bold">{accountsReceivable.overdueCount}</span>
                                    </div>
                                )}
                            </div>
                            <h3 className="text-sm font-semibold text-slate-600 dark:text-slate-400 mb-2">
                            ...
                            <div className="space-y-2">
                                <div className="text-3xl font-bold text-slate-900 dark:text-white">
                                    {formatCurrency(accountsReceivable.totalReceivable)}
                                </div>
                                <div className="space-y-1 pt-2 border-t border-amber-200 dark:border-amber-800">
                                    <div className="flex items-center justify-between text-xs">
                                        ...
                                        <span className="text-red-600 dark:text-red-400 font-bold">
                                            {formatCurrency(accountsReceivable.totalOverdue)}
                                        </span>
                                    </div>
                                    <div className="flex items-center justify-between text-xs">
                                        <span className="text-slate-500 dark:text-slate-400">A vencer</span>
                                        <span className="text-slate-700 dark:text-slate-300 font-semibold">
                                            {formatCurrency(accountsReceivable.totalUpcoming)}
                                        </span>
                                    </div>
                                </div>
                            </div>
