export const mockProspects = [
    {
        ...
        tradeName: 'Campo Sur',
        contact: 'juan.perez@agrosur.com',
        city: 'Tandil',
        ...
        contacts: [
            { contactId: 1, contactName: 'Juan Pérez', role: 'Gerente Comercial', isPrimary: true },
            { contactId: 3, contactName: 'Carlos Rodríguez', role: 'Asesor Técnico', isPrimary: false },
            { contactId: 5, contactName: 'Roberto Fernández', role: 'Socio Inversor', isPrimary: false }
        ]
    },
    {
        id: 2,
        ...
        contacts: [
            { contactId: 2, contactName: 'María González', role: 'Directora de Compras', isPrimary: true },
            { contactId: 3, contactName: 'Carlos Rodríguez', role: 'Consultor Externo', isPrimary: false }
        ]
    },
    {
        id: 3,
    ...
    },
    {
        ...
        contacts: [
            { contactId: 5, contactName: 'Roberto Fernández', role: 'Propietario', isPrimary: true }
        ]
    },
    {
        id: 5,
        ...
        convertedToClientId: 999,
        conversionDate: '2024-03-01T12:00:00',
        notes: 'Convertido a cliente el 01/03/2024.',
        contacts: [
            { contactId: 4, contactName: 'Ana Martínez', role: 'Gerente General', isPrimary: true }
        ]
    }
];
